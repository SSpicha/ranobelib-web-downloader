...
from .api_dto import normalize_chapter, normalize_novel_info
...
class RanobeLibAPI:
    ...
    def extract_slug_from_url(self, url: str) -> Optional[str]:
        ...
        if len(path_parts) >= 2 and path_parts[0] == "ru":
            if path_parts[1] == "book" and len(path_parts) >= 3:
                return path_parts[2]
            return path_parts[1]
        return None
    ...
    def get_novel_chapters(self, slug: str) -> List[Dict[str, Any]]:
        ...
        for chapter in chapters:
            ...
            if not is_on_moderation:
                filtered_chapters.append(normalize_chapter(chapter))
