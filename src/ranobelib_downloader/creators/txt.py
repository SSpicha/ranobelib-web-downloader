...
class TxtCreator(ContentProcessor):
    ...
    def create(
        ...
        print(f"[{self.format_name}] Создание {self.format_name}...")
    ...
    def _format_chapter_to_text(
        ...
        chapter_title = self.format_chapter_title(
            volume, prepared_chapter["number"], prepared_chapter.get("name"), total_volumes
        )
